...
class JudgeFashion():
    ...
    def get_fashion_results(self, image):
        ...
        for bbox in bboxes:
            ...
            person_croped = image[int(y):int(y+h), int(x):int(x+w),:]
...
def main():
    ...
    jf = JudgeFashion(model_path="./trained_modelv1.tflite", use_gpu=False, w="./person_detection/yolov3.weights", cfg="./person_detection/yolo.cfg")
